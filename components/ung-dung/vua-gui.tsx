 ...
 *
 * Đọc từ kho chứ không giữ trong trình duyệt: gửi xong là thẻ biến mất khỏi danh sách, nên
 * state cục bộ mất theo. Chồng bài ngắn lại đã là phản hồi, nhưng cô còn cần biết bài đó
 * ĐI ĐÂU — "biến mất" và "đã tới tay em" trông giống nhau nếu không nói ra.
 */
